...
```{python}
#| content: valuebox
#| title: "Average annual rate for a 30-year fixed mortgage in Oct. 2023"
dict(
  color = "danger",
  value = mortgages['fixed_30'].iloc[-1].item()
)
```

```{python}
#| content: valuebox
#| title: "Average annual rate for a 15-year fixed mortgage in Oct. 2023"
dict(
  value = mortgages['fixed_15'].iloc[-1].item()
)
```

```{python}
#| content: valuebox
#| title: "National median home price in thousands"
dict(
  value = hoi['median_price'].iloc[-1].item()
)
```
